...
def view_menu():
    while True:
        ...
        ####### MOHON MASUKKAN INPUT ANDA! #######
            ...
            1. Mengurutkan Data
            2. Mencari Data
            3. Lihat Data yang Telah Terhapus
            4. Kembali
            ''')
...
def find_data():
    ...
    while True:
        ...
        ####### MOHON MASUKKAN INPUT ANDA! #######
            ...
            2. Cari berdasarkan posisi
            3. Cari berdasarkan performance rating
            4. Kembali
            ''')
        ...
        if opt == '1':
            while True:
                ...
                for i in data_karyawan:
                    if i['Nama'] == iden:
                        data_karyawan_find.append(i)        
                        print(tabulate(data_karyawan_find, headers = 'keys', tablefmt='pretty'))            
                    else:
